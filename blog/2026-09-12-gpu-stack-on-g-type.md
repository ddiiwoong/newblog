...
`compute capability (8, 9)`가 RTX 4070 Ti SUPER와 같다. 메모리 사용량 200.125MB도 로컬 PC와 정확히 일치한다. 4096×4096 float32 텐서 세 개가 192MiB이고 여기에 cuBLAS 작업 공간이 더해진 값이므로 그래야 맞다.
