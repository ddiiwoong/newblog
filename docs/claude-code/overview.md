...
| # | 출처 | 상세 |
|---|------|------|
| [1] | **Claude Code Deep Dive Workshop — Chapter 1: Overview** | Choi WooHyung (Prin. Solutions Architect, AWS Korea), 2026.07. 192 슬라이드, 10 Parts. 내부 워크샵 교재 (Amazon Confidential). |
